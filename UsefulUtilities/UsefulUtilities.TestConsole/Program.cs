using UsefulUtilities.FC2DW;
using UsefulUtilities.Connections.Proxies;
using UsefulUtilities.Data.Culture;
using UsefulUtilities.Data.Dates;
using UsefulUtilities.Data.Delimited;
using UsefulUtilities.Data.Serialization;
using UsefulUtilities.FlexiCapture;
using UsefulUtilities.FTP;
using UsefulUtilities.Helpers;
using UsefulUtilities.Imaging.Core;
using UsefulUtilities.Imaging.Converters;
using UsefulUtilities.Logging;
using UsefulUtilities.Sage300HH2;
...
using System.Text;
using System.Net;
using UsefulUtilities.Data.Text;
using UsefulUtilities.LibPostalClient;
using System.Text.RegularExpressions;
using UsefulUtilities.Sage300HH2.Core.Generic;
using UsefulUtilities.Kingstone;
using UsefulUtilities.Kingstone.Core;
using System.Threading.Tasks;
using UsefulUtilities.DocuWareService;
...
using UsefulUtilities.DocuWare;

namespace UsefulUtilities.TestConsole
{
    public class Program
    {
        ...
        #region Useful Utilities Sample Scripts
