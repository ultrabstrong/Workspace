...
using UsefulUtilities.Kingstone.Connection;
...
namespace UsefulUtilities.Kingstone
{
    [Serializable]
    public class KingstoneConnection
    {
        ...
        public void Connect()
        {
            if(!IsConnected())
            {
                ...
                HttpResponseMessage result = Proxy.SendRequestForHttpResponse(Links.Authenticate, UsefulUtilities.Connections.HttpMethod.Post, null, authenticationHeaders, null);
        ...
        public void RefreshToken()
        {
            ...
            else
            {
                ...
                // Post to endpoint for authentication
                string result = Proxy.SendRequestForStringResult(Links.GetToken, UsefulUtilities.Connections.HttpMethod.Post, null, authenticationHeaders, param);
        ...
        internal T GetResult<T>(string link, HttpParameters parameter = null)
        {
            try
            {
                ...
                // Get result
                string resultString = Proxy.SendRequestForStringResult(link, UsefulUtilities.Connections.HttpMethod.Get, null, header, parameter);
                // Deserialize response
