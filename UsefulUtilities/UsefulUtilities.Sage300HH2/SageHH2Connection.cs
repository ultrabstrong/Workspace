...
using UsefulUtilities.Sage300HH2.Connection;
using UsefulUtilities.Sage300HH2.Core;
using UsefulUtilities.Sage300HH2.Core.Document;
using UsefulUtilities.Sage300HH2.Exceptions;
using System;
...
using rm = UsefulUtilities.Sage300HH2.Resources.Strings;
using UsefulUtilities.Sage300HH2.Core.Generic;
using UsefulUtilities.Security.Authentication;

namespace UsefulUtilities.Sage300HH2
{
    [Serializable]
    public class SageHH2Connection
    {
        ...
        public void Connect()
        {
            ...
            if (!IsConnected())
            {
                ...
                HttpResponseMessage result = Proxy.SendRequestForHttpResponse(Links.Authenticate, UsefulUtilities.Connections.HttpMethod.Post, Proxy.BuildJsonContent(JsonConvert.SerializeObject(content)), null, null);
        ...
        public RequestExecutionStatus GetOperationStatusForOperationId(string id)
        {
            ...
            return UsefulUtilities.Data.Serialization.XmlSerializer.DeSerialize<RequestExecutionStatus>(responsexml);
        }
        ...
        public string ExportDocument(string documentid)
        {
            ...
            return UsefulUtilities.Data.Serialization.XmlSerializer.DeSerialize<string>(responsexml);
        }
        ...
        internal T GetResult<T>(string link, HttpParameters parameter = null)
        {
            ...
            string xml = Proxy.SendRequestForStringResult(link, UsefulUtilities.Connections.HttpMethod.Get, null, header, parameter);
            // Deserialize response
            T result = UsefulUtilities.Data.Serialization.XmlSerializer.DeSerialize<T>(xml);
            return result;
        }
        ...
        internal string PostForStringContent(string link, HttpParameters parameter = null)
        {
                ...
                Dictionary<string, string> header = new Dictionary<string, string>
            {
                ...
                return Proxy.SendRequestForStringResult(link, UsefulUtilities.Connections.HttpMethod.Post, null, header, parameter);
            }
            catch (Exception ex)
            {
        ...
        internal string PostJsonForStringContent<T>(string link, T requestobj, HttpParameters parameter = null)
        {
            try
            {
                ...
                // Post for result GUID
                string result = Proxy.SendJsonRequestForStringResult(link, UsefulUtilities.Connections.HttpMethod.Post, requeststr, header, parameter);
